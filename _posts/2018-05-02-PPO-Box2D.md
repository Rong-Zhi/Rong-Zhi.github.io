...
\\[ -100(x^2+y^2)^2-100(V_x^2+V_y^2)^2-\mid100\theta\mid+10L_l+10L_r \\] 
...
Without the punishment for crush, the lander is capable to turn off the engine , similarly, without the reward for comming to rest, it learns how to land and get the average return around 100 as well. It seems like our PPO algorithm is stuck to local optimal solution.
